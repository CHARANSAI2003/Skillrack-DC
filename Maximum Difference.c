The program must accept N integers as the input. The program must print two integers among the N integers whose difference is maximum as the output. The two integers
