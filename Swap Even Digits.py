The program must accept an integer N as the input. The program must swap every two even digits in N and print the modifed N as the output. If there are odd number of 
even digits then the last digit cannot be swapped so the last digit must be printed as it is.
